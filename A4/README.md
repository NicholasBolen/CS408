...
Window size can be adjusted in the `A4.pde` file, simply change the `size(x, y, P3D)` function on line 9999 (when opened in processing editor) to fit your needs.
